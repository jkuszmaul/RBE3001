...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{motors_8h__dep__incl}
\end{center}
\end{figure}
...
\item[\hyperlink{todo__todo000008}{Todo}]Create a way to drive either link in any direction. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000006}{Todo}]Make a way to drive the links to a desired angle. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000007}{Todo}]Use kinematic equations to move the end effector to the desired position. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000009}{Todo}]Drive the arm to a known position using the potentiometers. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000005}{Todo}]Create way to stop the motors using the D\-A\-C. \end{DoxyRefDesc}
