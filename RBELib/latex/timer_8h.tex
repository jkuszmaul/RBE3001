...
\item[\hyperlink{todo__todo000021}{Todo}]Support different prescale modes. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000022}{Todo}]Create a function that will set a new compare value for the given timer. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000023}{Todo}]Test. \end{DoxyRefDesc}
