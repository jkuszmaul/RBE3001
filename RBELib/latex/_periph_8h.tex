...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_periph_8h__dep__incl}
\end{center}
\end{figure}
...
\item[\hyperlink{todo__todo000014}{Todo}]Find the current encoder ticks on a given channel. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000012}{Todo}]Make a function that can setup both encoder chips on the board. \end{DoxyRefDesc}
...
\end{DoxyReturn}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000010}{Todo}]Create a function that is able to find the acceleration of a given axis. \end{DoxyRefDesc}
...
\end{DoxyReturn}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000011}{Todo}]Make a function that is able to get the A\-D\-C value of the I\-R sensor. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000013}{Todo}]Clear the encoder count (set to 0). \end{DoxyRefDesc}
