...
\item[\hyperlink{todo__todo000021}{Todo}]Calculate the angle using the A\-D\-C reading. \end{DoxyRefDesc}
...
\end{DoxyReturn}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000022}{Todo}]Convert the A\-D\-C value into a voltage in m\-V (so no floats needed). \end{DoxyRefDesc}
