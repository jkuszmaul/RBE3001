...
\item[\hyperlink{todo__todo000019}{Todo}]Create a way to read all given pins on a port. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000018}{Todo}]Create a way to set a port's pins to inputs or outputs. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000020}{Todo}]Create a way to set all given pins on a port. \end{DoxyRefDesc}
