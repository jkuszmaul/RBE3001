...
\item[\hyperlink{todo__todo000023}{Todo}]Create the function that will allow you to initialize the S\-P\-I in a mode compatible with all devices. Do not forget to deassert all of your S\-S lines! \end{DoxyRefDesc}
...
\end{DoxyReturn}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000024}{Todo}]Make a function that will send a byte of data through the S\-P\-I and return whatever was sent back. \end{DoxyRefDesc}
